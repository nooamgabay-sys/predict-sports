  ...
  return (
    <div className="glass-card p-8 animate-slide-up">
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-slate-700/60 text-white text-sm font-medium hover:bg-white/10 hover:border-slate-600 transition-all duration-200 mb-6 disabled:opacity-50"
      >
